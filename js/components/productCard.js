export const productCard = (product) => {
    ...
    <div class="product-top">
      <a href="pages/pdp.html?id=${product.id}">  <img src="${product.image_url}" class="card-img-top img-fluid" alt="${product.title}">
    ...
    <div class="product-bottom  pt-3">
      <a href="pages/pdp.html?id=${product.id}"><h3 class="card-title mb-0">${product.title}</h3></a>
